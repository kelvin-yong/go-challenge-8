...
// func main() {
// 	s, err := sudoku.NewSudoku("123456789789123456456789123312845967000000000000000000000000000000000000000000000")
// 	if err == nil {
// 		start := time.Now()
// 		numOfSol := s.Solve(5000000)
// 		elapsed := time.Since(start)
// 		fmt.Println(numOfSol, elapsed)
// 	}
// }
